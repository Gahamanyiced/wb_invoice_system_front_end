...
// List of common currencies from around the world

const currencies = [
  // Default/Featured currencies (original list first for backward compatibility)
  ...
  // Additional world currencies (alphabetical by code)
